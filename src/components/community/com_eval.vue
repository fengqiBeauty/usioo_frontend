...
<div v-if="eval">
  <!-- 我要评价 -->
  <div class="f-star">
    <span class="title">中国象棋课程培训</span>
    <yd-rate slot="left" v-model="fy" active-color="#f39e34" size="0.38rem" class="star"></yd-rate>
  </div>
  <textarea class="remark pj" placeholder="说说你对该活动的评价吧！" v-model="remark"></textarea>
...
<style scoped>
.f-star{display: -webkit-box;display: -webkit-flex;display: flex;-moz-box-align: center; -webkit-box-align: center;align-items: center;padding: 0.2rem 0 0 0.2rem;}
.title {
  font-weight: 600;
  flex:1;
}
...
.butt {
  ...
  letter-spacing: 0.1rem;
	background: linear-gradient(to right, #4081CD,#4081CD,#4081CD,#76BAFB);
	box-shadow: none;
}
.st {
  position: relative;
